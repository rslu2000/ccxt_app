...
setTimeout(() => {
    ...
    console.log('binance/newtonxchange 可獲利機會', count['binance/newtonxchange'] || 0)
}, 60000)
...
setTimeout(() => {
    ...
    console.log('newtonxchange/gateio 可獲利機會', count['newtonxchange/gateio'] || 0)
}, 60000)
...
setTimeout(() => {
    ...
    console.log('newtonxchange/exx 可獲利機會', count['newtonxchange/exx'] || 0)
}, 60000)
